    ...
    Map save(paramaters) {
        ...
        if (cardapio == null) {
            try {
                ...
                model.put("message", mensagemService.getMensagem("cardapio.success.save"))
            } catch(Exception e) {
                println(e)
    ...
    Map update(paramaters) {
        ...
        if (cardapio) {
            try {
                ...
                model.put("status", "success")
                model.put("message", mensagemService.getMensagem("cardapio.success.update"))
            } catch(Exception e) {
                println(e)
                model.put("status", "error")
                model.put("message", mensagemService.getMensagem("default.error"))
    ...
    Map delete(id) {
        ...
        if (cardapio) {
            try {
                ...
                model.put("status", "success")
                model.put("message", mensagemService.getMensagem("cardapio.success.delete"))
                return model
            } catch(Exception e) {
                println(e)
                model.put("status", "error")
